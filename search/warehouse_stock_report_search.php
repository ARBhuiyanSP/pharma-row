...
<div class="card mb-3">
    <div class="card-header">
		<button class="btn btn-info" onclick="window.location.href='stock_report.php';"> Stock Report Search</button>
		<button class="btn btn-default"> Warehouse Stock Report Search</button>
		<button class="btn btn-info" onclick="window.location.href='categorywise_stock_report.php';"> Categorywise Stock Report Search</button>
		<button class="btn btn-info" onclick="window.location.href='warehouse_categorywise_stock_report.php';"> Warehouse Categorywise Stock Report Search</button>
	</div>
    <div class="card-body">
