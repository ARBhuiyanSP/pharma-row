...
<div class="card mb-3">
    <div class="card-header">
        ...
        Groupwise Consumption Report 
		<button class="btn btn-info" onclick="window.location.href='consumption_report.php';"> Date To Date Consumption Report</button>
		<button class="btn btn-info" onclick="window.location.href='consumption_pakg_build_report.php';"> Package and Bulding Wise Consumption Report</button>
		</div>
    <div class="card-body">
				...
				<div class="col-sm-12">	
					<center>
						<p>
							...
							<span>Warehouse wise consuption Report</span><br>
				...
				<table id="" class="table table-bordered table-striped ">
					...
					?>
						<tr>
							...
							<td><?php
							$sqloutqty = "SELECT SUM(`issue_qty`) AS totalout FROM `qry_inv_issue` WHERE `warehouse_id` = '$warehouse_id' AND `issue_date` BETWEEN '$from_date' AND '$to_date'  GROUP BY `material_id`";
