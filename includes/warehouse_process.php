 ...
 */
if (isset($_POST['warehouse_submit']) && !empty($_POST['warehouse_submit'])) {
        ...
        */ 
        ...
        $query = "INSERT INTO `inv_warehosueinfo` (`warehouse_id`,`name`,`project_id`,`address`) VALUES ('$warehouse_id','$name','$project_id','$address')";
        $conn->query($query);
        
		$_SESSION['success']    =   "Warehouse Entry process have been successfully completed.";
		header("location: warehouse_entry.php");
		exit();
}
